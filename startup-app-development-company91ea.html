...
<!-- Mirrored from www.konstantinfo.com/startup-app-development-company.php?request-a-quote by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Oct 2017 05:08:29 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<script type="text/javascript" async defer src="../apis.google.com/js/platform606f.js?publisherid=117079010775880771913">
		</script>

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-18381062-1"></script>
<script>
...
(function(p,u,s,h) {
    ...
    s.src = '../cdn.pushcrew.com/js/b2ab7413fd7b98e99c146d08d1f78d5d.js';
    h = u.getElementsByTagName('script')[0]; h.parentNode.insertBefore(s, h);
})(window,document);
</script>
<link rel="canonical" href="startup-app-development-company.html" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=0" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Googlebot" content="index, follow" />
<meta itemprop="name" content="Konstant Infosolutions Pvt. Ltd." />
<meta itemprop="description" content="Being a startup app development company, we create amazing user-friendly mobile apps for startups and entrepreneurs. Let's discuss your startup needs." />
<title>Startup App Development Company | Konstantinfo</title>
<meta name="description" content="Being a startup app development company, we create amazing user-friendly mobile apps for startups and entrepreneurs. Let's discuss your startup needs." />
<link rel="alternate" type="application/rss+xml" title="Konstant Infosolutions (P) Ltd - RSS" href="ror.xml" />
<meta property="fb:admins" content="117125028911" />

<meta property="og:url" content="https://www.konstantinfo.com/startup-app-development-company.php" />
<meta property="og:title" content="Startup App Development Company | Konstantinfo" />
<meta property="og:site_name" content="Konstant Infosolutions Pvt. Ltd." />
<meta property="og:description" content="Being a startup app development company, we create amazing user-friendly mobile apps for startups and entrepreneurs. Let's discuss your startup needs." />
<meta property="og:type" content="https://www.konstantinfo.com/startup-app-development-company.php" />
<meta property="og:image" content="https://www.konstantinfo.com/images/logo.png" />
<meta property="og:locale" content="en_us" />

<meta name="twitter:card" content="summary">
<meta name="twitter:url" content="https://www.konstantinfo.com/startup-app-development-company.php">
<meta name="twitter:creator" content="@konstantinfo">
<meta name="twitter:title" content="Startup App Development Company | Konstantinfo">
<meta name="twitter:description" content="Being a startup app development company, we create amazing user-friendly mobile apps for startups and entrepreneurs. Let's discuss your startup needs.">
<link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
<link rel="stylesheet" type="text/css" href="css/assets/main.mind870.css?1487926990" />
<link rel="stylesheet" type="text/css" href="css/assets/bootstrap.min34dc.css?1486446600" />
<link rel="stylesheet" type="text/css" href="css/material-design-iconic-font.min4119.css?1493215602" />
<link href="cache-css/cache-1507701619-52dc9b6b76737d1dee3d1d9b8c96ed09.css" rel="stylesheet" type="text/css"> 
<script src="cache-js/cache-1490182414-93c1cc83361ef9095c314c790a66e215.js" type="text/javascript"></script>
...
<script data-cfasync="false" type="text/javascript" src='../www.google.com/recaptcha/api6b7f.js?onload=CaptchaCallback&amp;render=explicit'></script>
...
/*Custom banner section height scroll */  

    $(document).on("scroll", onTaskCloneScroll);

    $('.task-li').click( function(){
        var selectedId = $(this).find('a').attr('href');
        //console.log($(selectedId).hasClass('get-in-touch-section'));
        var topSet = -140
        if($(selectedId).hasClass('get-in-touch-section')) {
            topSet = -300;
        }
		if(!$('header').hasClass('sticky fadeInM animated1')){
			//topSet = -360;
		}
		setTimeout(function(){  
			$.smoothScroll({
...
<body itemscope itemprop='mainEntity' itemtype='http://schema.org/Organization' class='no-scroll'> <progress id="progressbar" value="0" style="display:none"></progress>
<div class="start-a-project rq-ud-form ">
<div class="start-projectinner">
<div class="col-sm-12">
<header class="popup-header">
<a href="index.html"><img src="img/popup-logo97e4.png?1487942963" alt="Logo" /></a> <div class="circCont close-button">
<button type="button" class="circle" data-animation="showShadow" data-remove="3000" data-from="req-a-quote"></button>
</div>
</header>
</div>
<form action="https://www.konstantinfo.com/contacts/quotes" id="requestQuoteForm" name="requestQuoteForm" onsubmit="return validateRequestQuote()" enctype="multipart/form-data" novalidate="novalidate" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST" /></div> <div class="container">
<div class="row">
...
<input type="hidden" name="data[Contacts][country]" value="India" id="ContactsCountry2" /><input type="hidden" name="data[Contacts][city]" value="Gurgaon" id="ContactsCity2" /><input type="hidden" name="data[Contacts][zip]" value="" id="ContactsZip2" /><input type="hidden" name="data[Contacts][state]" value="" id="ContactsState2" /><input type="hidden" name="data[Contacts][ip]" value="" id="ContactsIp2" /><input type="hidden" name="data[Contacts][type]" value="request-quote" id="ContactsType2" /><input type="hidden" name="data[Contacts][calling_code]" value="+91" id="ContactsCallingCode2" /><input type="hidden" name="data[Contacts][source]" value="https://www.konstantinfo.com/startup-app-development-company.php" id="ContactsSource2" />
<div class="row">
...
<div class="progress-bar"></div ><div class="status"></div>
</div>
...
<button type="submit" style="border: none;" class="blue-new-btn nextButton" tabindex="0">Let&#039;s go!</button> </div>
</div>
</div>
</div>
</div>
...
<input type="hidden" name="data[Contacts][step_value]" id="step_value" value="" /></form> </div>
<p class="pinned--bottom-right">
Or send us an email at: <a href="cdn-cgi/l/email-protection.html#0d7e6c61687e4d6662637e796c637964636b62236e6260"><span class="__cf_email__" data-cfemail="f281939e9781b2999d9c8186939c869b9c949ddc919d9f">[email&#160;protected]</span></a>
</p>
...
</div> <div class="start-a-project--bg"></div>
...
<ul>
<li>
<a href="cdn-cgi/l/email-protection.html#3a495b565f497a515554494e5b544e53545c5514595557">
<i class="fa fa-envelope-o" aria-hidden="true"></i><span class="__cf_email__" data-cfemail="c8bba9a4adbb88a3a7a6bbbca9a6bca1a6aea7e6aba7a5">[email&#160;protected]</span>
</a>
</li>
<li class="number">
...
<div class="con-heading">Konstant Contacts</div>
...
<span>(If we don’t pick up, <a href="cdn-cgi/l/email-protection.html#5a32281a313534292e3b342e33343c3574393537">drop inquiry.</a>)</span>
</div>
</div>
</div>
</li>
...
<ul class="menu-links">
<li class="submenu"><a href="javascript:void(0)" class="transition">Why Konstant <i class="fa fa-caret-down" aria-hidden="true"></i></a>
<div class="dropdown">
...
<a href="partnership.html" class="comman-btn mt14">Become a Partner</a> </div>
<div class="sub-menu-sec highlight-link show-only-iphone">
<ul>
<li>
<a href="careers.html" class="">Join our team</a> </li>
<li>
<a href="partnership.html" class="">Become a Partner</a> </li>
</ul>
</div>
<div class="sub-menu-sec">
<div class="menuHeadTitle">Why Konstant</div>
<ul>
<li> <a href="about-us.html">About Us</a></li>
<li><a href="konstant-team.html">Our Team</a></li>
<li><a href="development-methodology.html">Our Development Process</a></li>

<li>
<a href="engagement-model.html">Engagement Models</a> </li>
...
<ul>
<li>
<a href="testimonials.html">Client Reviews</a> </li>
<li><a href="our-clients.html">Our Clients</a></li>
<li><a href="our-partners.html">Our Partners</a></li>
<li>
<a href="certifications-awards.html">Awards &amp; Memberships</a> </li>
...
<ul>
<li>
<a href="mobile-application-development.html">Mobile App Development</a> </li>
...
<li class="ssub-menu"><a href="wordpress-cms-development.html">WordPress</a> <span>|</span> <a href="joomla-cms-development.html">Joomla</a> <span>|</span><a href="drupal-cms-development.html">Drupal</a></li></ul>
<ul class="mt16">
...
<a href="case-study.html" class="comman-btn mt14">View Case Studies</a> </div>
<div class="sub-menu-sec highlight-link show-only-iphone">
<ul>
<li>
<a href="testimonials.html" class="">What Clients Say</a> </li>
<li>
<a href="case-study.html" class="">View Case Studies</a> </li>
</ul>
</div>
<div class="sub-menu-sec">
...
<a href="portfolios.html" class="transition">Work</a> </li>
...
<li>
<a href="contact-us.html" class="transition">Contact</a> </li>
</ul>
</div>
</div>
</nav>
...
<a href="index.html" itemprop="url"><img itemprop="logo" src="img/logo.png" alt="logo" /></a></div>
...
<div class="com-info">
<ul>
<li itemprop="email"> <a href="cdn-cgi/l/email-protection.html#3744565b5244775c585944435659435e5951581954585a"><i class="fa fa-envelope-o" aria-hidden="true"></i><span class="__cf_email__" data-cfemail="2053414c4553604b4f4e5354414e54494e464f0e434f4d">[email&#160;protected]</span></a> </li>
<li class="number"> <a href="javascript:void(0)"><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></a>
<div class="com-info-inquiry-dd">
<div class="com-info-inquiry">
<div class="con-heading">Konstant Contacts</div>
<div class="inquiry-block">
...
<div class="inqSal"> For Sales Inquiry</div>
<ul>
<li class="flag1" itemprop="telephone"><a href="tel:13109335465">+1-310-933-5465</a></li>
<li class="flag0" itemprop="telephone"><a href="tel:1888-866-0067">+1-888-866-0067</a> (Toll Free)</li>
<li class="flag2" itemprop="telephone"><a href="tel:442032397253">+44-203-239-7253</a></li>
<li class="flag3" itemprop="telephone"><a href="tel:911412291398">+91-141-2291398</a>, <a href="tel:911414028078">4028078</a></li>
</ul>
<span>(If we don’t pick up, <a class="cs_req_btn" href="javascript:void(0)">drop inquiry.</a>)</span>
</div>
<div class="inquiry-block">
...
<span>(If we don’t pick up, <a href="cdn-cgi/l/email-protection.html#a5cdd7e5cecacbd6d1c4cbd1cccbc3ca8bc6cac8">drop inquiry.</a>)</span>
</div>
</div>
</div>
</li>
...
<ul class="menu-links">
<li class="submenu">
<a href="javascript:void(0)" class="transition">Why Konstant
<i class="fa fa-caret-down" aria-hidden="true"></i>
</a>
<div class="dropdown">
<div class="sub-menu-section">
...
<li><a href="engagement-model.html">Engagement Models</a></li>
<li><a href="project-communication-strategy.html">Project Communication Strategy</a></li>
<li><a href="quality-commitment.html">Quality Assurance</a></li>
</ul>
</div>
...
<li><a href="our-clients.html">Our Clients</a></li>
<li>
<a href="our-partners.html">Our Partners</a> </li>
<li><a href="certifications-awards.html">Awards &amp; Memberships</a></li>
<li>
<a href="blog/index.html">Our Blog</a> </li>
</ul>
</div>
<div class="sub-menu-sec without-heading">
<div class="menuHeadTitle">&nbsp;</div>
<ul>
<li>
<a href="media-interviews.html">Press &amp; Media</a> </li>
<li>
<a href="contact-us.html">Contact Us</a> </li>
</ul>
</div>
...
<li class="submenu"><a href="javascript:void(0)" class="transition">Services <i class="fa fa-caret-down" aria-hidden="true"></i></a>
<div class="dropdown">
<div class="sub-menu-section">
<div class="container">
<div class="col-md-12">
...
<ul>
<li>
<a href="web-development.html">Web Development</a> </li>
<li class="ssub-menu"><a href="php-web-development.html">PHP</a><span>|</span> <a href="asp-dotnet-development.html">.NET</a> <span>|</span> <a href="java-application-development.html">JAVA</a></li>
</ul>
<ul class="mt16">
<li><a href="opensource-cms-development.html">Opensource Development</a></li>
...
<li><a href="wearable-devices-app-development.html">Wearable App Development</a></li>
<li><a href="cloud-application-development.html">Cloud Computing</a></li>
<li><a href="iot-application-development.html">IoT Development</a></li></ul>
<ul class="mt16">
<li><a href="consulting-services.html">Consulting Services</a> </li>
<li><a href="software-maintenance-support.html">Software Maintenance &amp; Support</a></li>
<li><a href="enterprise-app-development.html">Enterprise Software Development</a></li>
...
<li class="submenu"><a href="javascript:void(0)" class="transition">Solutions <i class="fa fa-caret-down" aria-hidden="true"></i></a>
<div class="dropdown">
<div class="sub-menu-section">
<div class="container">
<div class="col-md-12">
...
<a href="portfolios.html" class="transition">Work</a> </li>
<li>
<a href="resources.html" class="transition">Resources</a> </li>
<li>
<a href="contact-us.html" class="transition">Contact</a> </li>
</ul>
</div>
...
<section class="innerpage-banner mobile-banner-height selected Page-scrolling-fixed-banner" style="background:url(img/banners/startup-banner.jpg) no-repeat center top;  background-size: cover;">
<div class="container">
<div class="in-banner-content fadeInUp animated3">
<h1>We build world-class solutions <br />
for the Startup age</h1>
<p>Bridging the Gap between Startup and Enterprise - We do it the BEST</p>
...
<li class="task-li"> <a href="#overflow-slide_2"> <i class="fa fa-circle" aria-hidden="true"></i><span>Result-Oriented Approach</span> </a> </li>
<li class="task-li"> <a href="#overflow-slide_3"> <i class="fa fa-circle" aria-hidden="true"></i><span>Our Startup Portfolio</span> </a> </li>
...
<div class="col-md-12">
<div class="row">
<h2>Startup app development is our obsession, and<br />
we are obsessively focused on startup’s mission</h2>
<p class="mt30">Having already worked with over 200+ startup projects, we are fueled to develop brilliant and powerful web and mobile apps across industries that will raise untold fortunes of millions of entrepreneurs who are struggling to launch lucrative businesses to meet a marketplace need.</p>
</div>
</div>
</div>
</div>
...
<section id="overflow-slide_1" class="startup-sec1 light_blue_bg">
<div class="container">
<div class="main-content-block new-main-content-block rows fadeInUp animated3 mt70">
<h2>We're a top-ranked <br />
startup app development company</h2>
<div class="title-bar">A wide range of robust and scalable solutions to foster your idea</div>
</div>
<div class="rows kpProgram mt30">
<div class="col-md-12">
<div class="row">
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon  maintenance transition "></span>
<h2>Experienced team</h2>
<p>Experts in Android, iOS, E and M-commerce, Magento, PhoneGap, Xamarin, HTML5 &amp; others</p>
</div>
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon adv_resors transition "></span>
<h2>Scalable development</h2>
<p>A focused and phased approach to build-to-market, to scale and to grow</p>
</div>
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon custom-built transition "></span>
<h2>Custom-built solutions</h2>
<p>For every unique idea, we offer adaptability and flexibility to suit your business needs</p>
</div>
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon cost-effective transition "></span>
<h2>Cost-effective services</h2>
<p>Be it a low-funded startup or a billion-dollar venture, we guarantee cost-effectiveness</p>
</div>
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon techLed transition "></span>
<h2>Technology leadership</h2>
<p>IoT, AR/VR, Cloud, Cross-platform, Wearable, Beacon- we create everything &amp; beyond </p>
</div>
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon value  transition "></span>
<h2>Value proposition</h2>
<p>The end-product is assured to add value to your business and deliver it to users</p>
</div>
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon innovation transition "></span>
<h2>Innovation &amp; novelty</h2>
<p>Innovation is our core value and we love to go beyond the limitations to deliver out-of-the-box </p>
</div>
<div class="col-md-3 col-sm-4"> <span class="partnersIcon crossIcon fullSupport transition "></span>
<h2>Full support ecosystem</h2>
<p>Your queries and doubts are resolved and taken care of even after launch</p>
</div>
</div>
</div>
</div>
...
<section id="overflow-slide_2" class="chatSolution blue_bg ideas-block">
<div class="container">
<div class="chatInr">
<h2>Building successful enterprises <br />
from your startup idea</h2>
<span class="chatsubTitle">THE FOUR STAGES FROM STARTUPS TO FULL-SIZED ENTERPRISES</span> </div>
<div class="appSolution row">
<div class="col-sm-3">
<div class="appSolution_block1"> <span class="purposeIcons longTerm  transition"></span>
<div class="appName">Streamlining the Idea</div>
<p>With proven industry experience
and extensive market research across
industries, we validate your idea and
present a viable solution</p>
</div>
</div>
<div class="col-sm-3">
<div class="appSolution_block1"> <span class=" purposeIcons discoverMission transition"></span>
<div class="appName">Discover your mission</div>
<p>As a startup serving agency, we dig
deep inside your brain and recognize
your vision, mission and expectations
from the business solution</p>
</div>
</div>
<div class="col-sm-3">
<div class="appSolution_block1"> <span class="purposeIcons perfectProd transition"></span>
<div class="appName">Perfect product execution</div>
<p>Realizing all the needs, we work towards
developing secure, cleanly coded, mobile
friendly, scalable and fully documented
product (be it web or mobile)</p>
</div>
</div>
<div class="col-sm-3">
<div class="appSolution_block1"> <span class="purposeIcons streamlining transition"></span>
<div class="appName">Long-term growth</div>
<p>We work continuously towards
upgrading and enhancing your
online product, adding latest features to
keep it fresh and ever-evolving</p>
</div>
 </div>
</div>
<div class="btnRow mt10"> <a href="#overflow-slide_5" class="bcm_btn transition cbss">Contact us</a> </div>
</div>
</section>
<section id="overflow-slide_3" class="profileSlide flexslider landing-bottom-slider">
<ul class="slides">
<li>
<div class="slide1" style="background-image: url('../s3-us-west-2.amazonaws.com/konstant-pipeline/k_portfolio/homepage_bg/1487064103_randevu.jpg'); background-color:#1F1F1F;">
<div class="container">
<div class="row">
...
<p>Randevu’s mission is to be the first app to introduce the world of online dating to good old chivalry.&nbsp;</p> </div>
<div class="case_app_icon1">
<ul>
<li class="border_colr"><span class="cib-tooltip">Website</span><a rel="nofollow" href="https://goo.gl/mS0wAh" target="http://randevuapp.com/" title=""><img alt="" src="img/arrow.png" style="border-width:0px;" /></a></li><li class="border_colr"><span class="cib-tooltip">iPhone</span><a rel="nofollow" href="https://goo.gl/0vssvZ" target="https://itunes.apple.com/us/app/randevu-app/id1185782244?mt=8" title=""><span class="i-icon"><i class="fa fa-apple" aria-hidden="true"></i></span></a></li><li class="btn_separator"></li> <li class="pdrL border_colr appvideo">
<a href="javascript:void(0)" style="text-decoration:none" class="video-btn-play " id="vidwrap-82" onclick="play_landing(this);" data-att="https://player.vimeo.com/video/174540172?autoplay=1?autoplay=1&amp;controls=1&amp;showinfo=0&amp;modestbranding=0&amp;enablejsapi=1&amp;rel=0">
...
<li>
<div class="slide1" style="background-image: url('../s3-us-west-2.amazonaws.com/konstant-pipeline/k_portfolio/homepage_bg/1487341991_what-a-gobber.jpg'); background-color:#1F1F1F;">
<div class="container">
<div class="row">
<div class="col-md-5 col-sm-12">
<div class="slide_detail fadeInDown animated3">
<div class="study_title">
<span> WhataGoober </span> /
Social Networking
</div>
<div class="slidTitile">
<p>A free messaging app that lets you chat with your friends, with an optional <strong>self-destruct feature</strong>. It allows you to <strong>share stickers</strong>, and <strong>play games</strong> while staying connected to your social feeds! &nbsp;</p> </div>
<div class="case_app_icon1">
<ul>
<li class="border_colr"><span class="cib-tooltip">Website</span><a rel="nofollow" href="https://goo.gl/mb5Zmm" target="http://whatagoober.com/" title=""><img alt="" src="img/arrow.png" style="border-width:0px;" /></a></li><li class="border_colr"><span class="cib-tooltip">iPhone</span><a rel="nofollow" href="https://goo.gl/OwVoqq" target="https://itunes.apple.com/in/app/whatagoober/id923281942?mt=8" title=""><span class="i-icon"><i class="fa fa-apple" aria-hidden="true"></i></span></a></li><li class="border_colr"><span class="cib-tooltip">Android</span><a rel="nofollow" href="https://goo.gl/KqQQA8" target="https://play.google.com/store/apps/details?id=com.whatagoober&hl=en" title=""><span class="i-icon"><i class="fa fa-android" aria-hidden="true"></i></span></a></li>
</ul>
</div>
</div>
</div>
...
<li>
<div class="slide1" style="background-image: url('../s3-us-west-2.amazonaws.com/konstant-pipeline/k_portfolio/homepage_bg/1481794959_houseme_background.jpg'); background-color:#1F1F1F;">
<div class="container">
<div class="row">
<div class="col-md-5 col-sm-12">
<div class="slide_detail fadeInDown animated3">
...
<div class="slidTitile">
<p>Revolutionary rental platform that connects dream tenants to verified landlords.</p> </div>
<div class="case_app_icon1">
<ul>
<li class="border_colr"><span class="cib-tooltip">Website</span><a rel="nofollow" href="https://goo.gl/MnKCp8" target="http://houseme.co.za/" title=""><img alt="" src="img/arrow.png" style="border-width:0px;" /></a></li><li class="border_colr"><span class="cib-tooltip">Iphone</span><a rel="nofollow" href="https://goo.gl/47dLWi" target="https://itunes.apple.com/us/app/houseme-sa/id1152832691?ls=1&mt=8" title=""><span class="i-icon"><i class="fa fa-apple" aria-hidden="true"></i></span></a></li><li class="border_colr"><span class="cib-tooltip">Android</span><a rel="nofollow" href="https://goo.gl/srlTVk" target="https://play.google.com/store/apps/details?id=com.app.houseme" title=""><span class="i-icon"><i class="fa fa-android" aria-hidden="true"></i></span></a></li><li class="btn_separator"></li> <li class="pdrL border_colr appvideo">
...
<blockquote>
<p class="title">
Konstant Infosolutions has <strong>built a complex system</strong> and throughout the process has remained communicative, <strong>quick-to-respond</strong> and <strong>highly agile</strong> as the project pivoted. <strong>Support has been excellent</strong> to date and minor bugs have been ironed out within hours. </p>
<div class="post-block">
<h3>
Benjamin Shaw, <span>CEO</span> </h3>
</div>
</blockquote>
...
<li>
<div class="slide1" style="background-image: url('../s3-us-west-2.amazonaws.com/konstant-pipeline/k_portfolio/homepage_bg/1486373694_tweety-pad.jpg'); background-color:#1F1F1F;">
<div class="container">
<div class="row">
<div class="col-md-5 col-sm-12">
<div class="slide_detail fadeInDown animated3">
...
<div class="slidTitile">
<p>Tweetypad Pro allows you to post to your Twitter account<strong> without being limited to the 140-character limit</strong>, all in one step from one convenient place.<br></p> </div>
<div class="case_app_icon1">
<ul>
<li class="border_colr"><span class="cib-tooltip">Website</span><a rel="nofollow" href="https://goo.gl/WXj03R" target="http://tweetypad.com/" title=""><img alt="" src="img/arrow.png" style="border-width:0px;" /></a></li><li class="border_colr"><span class="cib-tooltip">Pro iPhone App</span><a rel="nofollow" href="https://goo.gl/TjXZrb" target="https://itunes.apple.com/in/app/tweetypad/id1201113007?mt=8" title=""><span class="i-icon"><i class="fa fa-apple" aria-hidden="true"></i></span></a></li><li class="border_colr"><span class="cib-tooltip">iPhone App</span><a rel="nofollow" href="https://goo.gl/Py1nG5" target="https://itunes.apple.com/in/app/tweetypad-pro/id1201177126?mt=8" title=""><span class="i-icon"><i class="fa fa-apple" aria-hidden="true"></i></span></a></li><li class="border_colr"><span class="cib-tooltip">Pro Android App</span><a rel="nofollow" href="https://goo.gl/ZuvSdS" target="https://play.google.com/store/apps/details?id=com.tweetypad.pro&hl=en" title=""><span class="i-icon"><i class="fa fa-android" aria-hidden="true"></i></span></a></li><li class="btn_separator"></li> <li class="pdrL border_colr appvideo">
...
<li>
<div class="slide1" style="background-image: url('../s3-us-west-2.amazonaws.com/konstant-pipeline/k_portfolio/homepage_bg/1487762737_cantaloop.jpg'); background-color:#1F1F1F;">
<div class="container">
<div class="row">
<div class="col-md-5 col-sm-12">
<div class="slide_detail fadeInDown animated3">
...
<div class="slidTitile">
<p>Cantalop.com is the <strong>1st Regional Job Search Engine</strong> dedicated to Egypt &amp; Middle East Region.&nbsp;The website have all jobs listed in one place and create a healthier job market place in the MENA Region.</p> </div>
<div class="case_app_icon1">
<ul>
<li class="border_colr"><span class="cib-tooltip">Website</span><a rel="nofollow" href="https://goo.gl/LB6Xtd" target="https://www.cantalop.com/" title=""><img alt="" src="img/arrow.png" style="border-width:0px;" /></a></li>
</ul>
</div>
</div>
</div>
...
<div class="container">
<div class="chatInr">
<h2>Optimizing startup partnership for growth</h2>
<span class="chatsubTitle">Collaborative. Transparent. Strategic</span>
<p>Our startup app development services cover all bases. Once we work together, we develop that warm feeling of seeing startups grow because their success reflects our growth- and we love to excel like a team. A significant percentage of our resources is dedicated towards incubation projects.</p>
<div class="btnRow mt50"> <a href="#overflow-slide_5" class="bcm_btn transition cbss">Talk to Our Startup Experts</a> </div>
</div>
</div>
</section>
...
<script type="text/javascript">
	...
	function loadTestimonials(ttype){
		...
		var action = "https://www.konstantinfo.com/app/getLatestTestimonial/"+random;
		var pageData = 'a:2:{s:11:"headingType";s:12:"startup_page";s:17:"showDiscussButton";b:1;}';
		$.ajax({
			type:"POST",
			url:action,
...
<section id="overflow-slide_5" class="get-in-touch-section top-bofu">
<div class="container">
...
<a href="cdn-cgi/l/email-protection.html#cab9aba6afb98aa1a5a4b9beaba4bea3a4aca5e4a9a5a7" class="transition">
<i class="email-icon"></i> <span class="small-text rows">mail to our sales department</span>
<span class="large-text rows"><span class="__cf_email__" data-cfemail="f083919c9583b09b9f9e8384919e84999e969fde939f9d">[email&#160;protected]</span></span>
</a>
</div>
<div class="emailid-block voicemsg rows marT20">
<a href="skype:webintegrated?call" class="transition"><i class="skype-icon"></i> <span class="small-text rows">Our Skype Id</span> <span class="large-text rows">webintegrated</span> </a>
</div>
...
<form action="https://www.konstantinfo.com/contact-us.php" id="contactForm" name="contactForm" onsubmit="return validateGetintouch()" enctype="multipart/form-data" novalidate="novalidate" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST" /></div><input type="hidden" name="data[Contacts][country]" value="India" id="ContactsCountry" /><input type="hidden" name="data[Contacts][city]" value="Gurgaon" id="ContactsCity" /><input type="hidden" name="data[Contacts][zip]" value="" id="ContactsZip" /><input type="hidden" name="data[Contacts][state]" value="" id="ContactsState" /><input type="hidden" name="data[Contacts][ip]" value="" id="ContactsIp" /><input type="hidden" name="data[Contacts][type]" value="footer" id="ContactsType" /><input type="hidden" name="data[Contacts][calling_code]" value="+91" id="ContactsCallingCode" /><input type="hidden" name="data[Contacts][source]" value="https://www.konstantinfo.com/startup-app-development-company.php" id="ContactsSource" /> <div class="form-group input-effect">
<div>
<i class="name"></i>
...
<option value="$50,000 - $1,00,000">$50,000 - $1,00,000</option>
<option value="$100,000+">$100,000+</option>
</select> <label>Your Budget*</label>
<div class="select__arrow"></div>
<span class="focus-border"></span>
</div>
</div>
...
<div>
<textarea name="data[Contacts][message]" class="form-control input-effect LoNotSensitive" rows="3" tabindex="0" id="ContactsMessage"></textarea> </div>
</div>
...
<button type="submit" class="comman-btn" tabindex="0">Send your Inquiry</button> </div>
</form>
</div>
...
<span class="note-line">Give it a try. It only takes a click to unsubscribe.</span> </div>
</div>
</div>
